        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": (
                    ...
                    보고서를 기반으로 요약해야 합니다. **는 쓰지 말아주고 들여쓰기도 하지 말아주세요.
                    어조는 "~입니다, ~합니다" 같은 존댓말이 아닌, "~이다, ~한다" 식으로 써주세요.
                    [보고서 요약 양식]
                    1. 시장 동향:
                    (현재 반도체 시장의 전반적인 흐름과 수요·공급, 가격, 투자심리 등의 변화를 정리합니다.)
                    2. 산업 이슈:
                    (산업 전반에 영향을 미치는 정책, 지정학적 리스크, 공급망 문제 등의 주요 이슈를 다룹니다.)
                    3. 기술 트랜드:
                    ( 공정 미세화, HBM, AI 반도체같은 핵심 기술 및 제품 관련 최신 동향을 요약합니다.)
                    4. 기타 전략적 인사이트:
                    (주요 기업의 전략, 업계 재편, 투자 방향 등 중장기적 관점에서 주목할 내용을 제시합니다.)
                    5. 주요 키워드 : 
                    (반도체 산업 관점에서 핵심 키워드를 5개에서 10개 추출합니다)
                    """
                )},
